...
ProcessFile()
{
	ragel $OPTIONS -o $1/$2.js ./ragel/$3.jrl
...
ragel $OPTIONS -o ./src/parsers/tsip_parser_uri.js ./ragel/tsip_parser_uri.jrl
...
# ==Allow see StrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Allow.js ./ragel/tsip_parser_header_Allow.jrl

# ==Allow-Events (see StrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Allow_Events.js ./ragel/tsip_parser_header_Allow_Events.jrl

# ==Authorization
ProcessFile "./src/headers" "tsip_header_Authorization" "tsip_parser_header_Authorization"

# ==Call-ID (see Str)
# ragel $OPTIONS -o ./src/headers/tsip_header_Call_ID.js ./ragel/tsip_parser_header_Call_ID.jrl

# ==Contact
ProcessFile "./src/headers" "tsip_header_Contact" "tsip_parser_header_Contact"

# ==Content-Length (see Int)
#ragel $OPTIONS -o ./src/headers/tsip_header_Content_Length.js ./ragel/tsip_parser_header_Content_Length.jrl
...
# ==Event (see Str)
#ragel $OPTIONS -o ./src/headers/tsip_header_Event.js ./ragel/tsip_parser_header_Event.jrl

# ==Expires (see Int)
#ragel $OPTIONS -o ./src/headers/tsip_header_Expires.js ./ragel/tsip_parser_header_Expires.jrl

# ==From (See NameAddr)
#ragel $OPTIONS -o ./src/headers/tsip_header_From.js ./ragel/tsip_parser_header_From.jrl
...
#ragel $OPTIONS -o ./src/headers/tsip_header_Max_Forwards.js ./ragel/tsip_parser_header_Max_Forwards.jrl

# ==Min-Expires (see Int)
#ragel $OPTIONS -o ./src/headers/tsip_header_Min_Expires.js ./ragel/tsip_parser_header_Min_Expires.jrl

# ==Min-SE (see Int)
#ragel $OPTIONS -o ./src/headers/tsip_header_Min_SE.js ./ragel/tsip_parser_header_Min_SE.jrl

# ==P-Access-Network-Info (see Str)
#ragel $OPTIONS -o ./src/headers/tsip_header_P_Access_Network_Info.js ./ragel/tsip_parser_header_P_Access_Network_Info.jrl

# ==P-Asserted-Identity (see NameAddrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_P_Asserted_Identity.js ./ragel/tsip_parser_header_P_Asserted_Identity.jrl

# ==P-Associated-URI (see NameAddrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_P_Associated_URI.js ./ragel/tsip_parser_header_P_Associated_URI.jrl
...
#ragel $OPTIONS -o ./src/headers/tsip_header_Path.js ./ragel/tsip_parser_header_Path.jrl

# ==Privacy (se StrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Privacy.js ./ragel/tsip_parser_header_Privacy.jrl
...
#ragel $OPTIONS -o ./src/headers/tsip_header_Refer_To.js ./ragel/tsip_parser_header_Refer_To.jrl

# ==Referred-By (see NameAddr)
#ragel $OPTIONS -o ./src/headers/tsip_header_Referred_By.js ./ragel/tsip_parser_header_Referred_By.jrl

# ==Record-Route (see NameAddrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Record_Route.js ./ragel/tsip_parser_header_Record_Route.jrl

# ==Require (see StrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Require.js ./ragel/tsip_parser_header_Require.jrl

# ==Route (see NameAddrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Route.js ./ragel/tsip_parser_header_Route.jrl

# ==RSeq (see Int)
#ragel $OPTIONS -o ./src/headers/tsip_header_RSeq.js ./ragel/tsip_parser_header_RSeq.jrl

# ==Server (see Str)
#ragel $OPTIONS -o ./src/headers/tsip_header_Server.js ./ragel/tsip_parser_header_Server.jrl

# ==Service-Route (see NameAddrArray)
#ragel $OPTIONS -o ./src/headers/tsip_header_Service_Route.js ./ragel/tsip_parser_header_Service_Route.jrl

# ==Session-Expires
ProcessFile "./src/headers" "tsip_header_Session_Expires" "tsip_parser_header_Session_Expires"

# ==SIP-ETag (see Str)
#ragel $OPTIONS -o ./src/headers/tsip_header_SIP_ETag.js ./ragel/tsip_parser_header_SIP_ETag.jrl

# == SIP-If-Match (See Str)
#ragel $OPTIONS -o ./src/headers/tsip_header_SIP_If_Match.js ./ragel/tsip_parser_header_SIP_If_Match.jrl
...
#ragel $OPTIONS -o ./src/headers/tsip_header_Supported.js ./ragel/tsip_parser_header_Supported.jrl

# ==To (see NameAddr)
#ragel $OPTIONS -o ./src/headers/tsip_header_To.js ./ragel/tsip_parser_header_To.jrl

# == User-Agent (see Str)
#ragel $OPTIONS -o ./src/headers/tsip_header_User_Agent.js ./ragel/tsip_parser_header_User_Agent.jrl
